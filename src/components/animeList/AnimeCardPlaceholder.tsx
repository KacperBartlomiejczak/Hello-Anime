...
export default function CardPlaceholder() {
  return (
    <div className="relative bg-secondary-background rounded-xl w-72 md:w-80 h-[510px] flex flex-col shrink-0 overflow-hidden shadow-lg border border-white/5">
      {/* Image Placeholder */}
      <div className="relative w-full h-64 shrink-0 bg-secondary/30 overflow-hidden">
        <motion.div
          className="w-full h-full absolute inset-0 bg-linear-to-r from-transparent via-white/10 to-transparent"
          initial={{ x: "-100%" }}
          animate={{ x: "100%" }}
          transition={{
            repeat: Infinity,
