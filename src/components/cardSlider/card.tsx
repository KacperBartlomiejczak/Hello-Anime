...
export default function Card({ ...anime }: Anime) {
  return (
    <Link
      ...
      className="group relative bg-secondary-background rounded-xl w-80 h-[510px] flex flex-col shrink-0 overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-brand/20 transition-all duration-300 border border-white/5 hover:border-brand/30"
    >
